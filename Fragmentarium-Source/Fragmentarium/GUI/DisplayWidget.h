...
"#else\n"
"#if __VERSION__ < 330 && __VERSION__ > 120 || (defined(GL_es_profile) && GL_es_profile == 1)\n"
"in vec4 vertex_position;\n"
"#endif\n"
"#endif\n"
"#if __VERSION__ <= 120 && !(defined(GL_es_profile) && GL_es_profile == 1)\n"
...
"in vec4 vertex_position;\n"
"#else\n"
"#if defined(GL_es_profile) && GL_es_profile == 1\n"
